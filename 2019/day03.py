...
for path in second:
    ...
    for i in range(0, int(step)):
        if direction == 'U':
            ...
            cur_x -= 1
        cor_second.append((cur_x, cur_y))

cross = set(cor_first) & set(cor_second)
print(cor_first)
print(cor_second)
print(cross)
# min_dis = 10000000
